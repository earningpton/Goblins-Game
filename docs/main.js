...
function longBlink(elemID){
    ...
    if (longBlinkCounter > 5 && longBlinkCounter < 10){
        document.getElementById("hypnoDroneText").innerHTML="Kill";
        }

    if (longBlinkCounter > 30 && longBlinkCounter < 40){
        document.getElementById("hypnoDroneText").innerHTML="<br /><br /><br />Kill";
        }

    if (longBlinkCounter > 45 && longBlinkCounter < 55){
        document.getElementById("hypnoDroneText").innerHTML="<br />Kill";
        }
